				...
				<div className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
					<div className="w-[49%] ml-5 max-md:w-full max-md:ml-0">
						<div className="flex flex-col items-stretch my-auto max-md:max-w-full max-md:mt-10">
							<div className="text-black text-xl font-semibold max-md:max-w-full">Home</div>
					...
					<div className="flex flex-col items-stretch w-[30%] ml-5 max-md:w-full max-md:ml-0">
						<div className="mt-12 border border-[color:var(--background-background-600,#E8E8E8)] shadow-sm bg-white flex w-full flex-col items-stretch m-auto pt-4 pb-12 px-7 border-solid max-md:mt-10 max-md:px-5">
							<span className="flex items-stretch justify-between gap-5">
								<Image
									alt="picture"
									height={0}
