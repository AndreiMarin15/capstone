...
import middleware from "@/app/lib/backend/middleware";
			...
			<div className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
				<div className="flex flex-col items-stretch w-[60%] max-md:w-full max-md:ml-0">
					<div className="flex flex-col my-auto max-md:mt-10">
						...
						<button
							onClick={() => {
								middleware.logIn().then((data) => {
									console.log(data);
									if (data.user.id && data.user.aud === "authenticated") {
										middlewareuser.setInfo(data.user);
										setTimeout(() => {
