...
export default function Middleware() {
  ...
  const medicationfields = [
    ...
    },
    {
      ...
      value: "",
      message:
        "Refers to the form of the medication. \n contains: {text: description}}",
    },
    {
      src: "https://cdn.builder.io/api/v1/image/assets/TEMP/d19836557e1663895fdf541cf9cb7830a89d1289dd6769b52c91d8a61b9f5e13?",
      variable: "note",
    ...
    },
    {
      ...
      value: "",
      message:
        "The patient who is taking the medication. Contains: {reference: Patient}",
    },
    {
      src: "https://cdn.builder.io/api/v1/image/assets/TEMP/d19836557e1663895fdf541cf9cb7830a89d1289dd6769b52c91d8a61b9f5e13?",
      variable: "requester",
      value: "",
      message:
        "The practitioner who requested the medication. Contains: {reference: Practitioner}",
    },
    {
      src: "https://cdn.builder.io/api/v1/image/assets/TEMP/d19836557e1663895fdf541cf9cb7830a89d1289dd6769b52c91d8a61b9f5e13?",
      ...
      value: "",
      message:
        "Describes if there is a reaction to the medication. Contains: {adverseReaction: data}",
    },
    {
      src: "https://cdn.builder.io/api/v1/image/assets/TEMP/d19836557e1663895fdf541cf9cb7830a89d1289dd6769b52c91d8a61b9f5e13?",
    ...
    },
    {
      ...
      value: "",
      message:
        "Contains the dosage instructions of the medication. Contains: {doseAndRate: [{doseQuantity: dosage}]}",
    },
  ];
    ...
    <div className="flex flex-col  px-5 bg-white max-w-full">
      <div className="w-full text-xl ml-10 mt-10 font-semibold leading-8 text-black max-md:max-w-full">
        ...
        <div className="flex gap-1 items-center text-s">
          <div className="gap-1 text-black text-sm font-semibold leading-5 self-center my-auto">
            API Key
          </div>
          <input
            onChange={(e) => {
      ...
      <div className="flex ml-10 gap-2.5 px-0.5 mt-9 text-sm font-semibold leading-5 text-black max-md:flex-wrap">
        <button
