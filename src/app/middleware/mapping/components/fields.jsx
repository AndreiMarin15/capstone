          ...
          <td className="border-l-[16px] border-transparent">
            <div className="flex gap-1 items-center">
              ...
              {hoveredImageId === index && (
                <div
                  className="text-sm absolute top-[calc(100% + 5px)] left-1/2 bg-gray-200 p-2 rounded shadow-md transform -translate-x-1/2 flex justify-center items-center z-10" // Adjusted z-index to bring it to the front
