				...
				<div className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
					<div className="flex flex-col items-stretch w-[21%] max-md:w-full max-md:ml-0">
						<div className="flex items-center gap-4 my-auto max-md:mt-10">
							...
							<span className="items-stretch self-stretch flex grow basis-[0%] flex-col">
								<div className="text-black text-xs font-semibold leading-5 whitespace-nowrap">Brand Name</div>
								<div className="text-black text-xs font-semibold leading-5 whitespace-nowrap mt-9">Generic Name</div>
								<div className="text-black text-xs font-semibold leading-5 mt-9">Dose</div>
								<div className="text-black text-xs font-semibold leading-5 mt-9">Form</div>
								<div className="text-black text-xs font-semibold leading-5 mt-9">Quantity</div>
								<div className="text-black text-xs font-semibold leading-5 mt-9">Note</div>
							</span>
						</div>
					</div>
					<div className="flex flex-col items-stretch w-[79%] ml-5 mt-5 max-md:w-full max-md:ml-0">
						<span className="items-stretch flex flex-col my-auto max-md:max-w-full max-md:mt-10">
							<div className="text-black text-xs leading-5 max-md:max-w-full">Losartan</div>
							<div className="text-black text-xs leading-5 mt-9 max-md:max-w-full">Losartan</div>
							<div className="text-black text-xs leading-5 mt-9 max-md:max-w-full">50 mg</div>
							<div className="text-black text-xs leading-5 mt-9 max-md:max-w-full">Tablet</div>
							<div className="text-black text-xs leading-5 mt-9 max-md:max-w-full">30</div>
							<div className="text-black text-xs leading-5 mt-9 max-md:max-w-full">
								<ul>
									<li>1 tablet 1x/ day for 30 days</li>
									<li>
										30 minutes of moderate-intensity exercise (e.g., brisk walking, swimming, or cycling) at least five
										days a week.
									</li>
								</ul>
							</div>
