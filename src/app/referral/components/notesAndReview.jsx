...
export default function NotesAndReview({ selectedDoctor, selectedPatient, notes, setNotes }) {
		...
		<div className="flex flex-col ml-2 mr-6">
			<div className="border border-[color:var(--background-background-600,#E8E8E8)] shadow-sm bg-white w-[96%] pl-8 py-6 ml-10">
				<div className="gap-5 flex">
					<span className="flex grow flex-col w-[10%]">
						<div className="text-black text-base font-semibold">Selected Doctor</div>
						...
						{selectedDoctor.name ? (
							<>
								<div className="flex items-stretch justify-between gap-4 mt-5">
									...
									<span className="self-center flex grow basis-[0%] flex-col items-stretch my-auto">
										<div className="text-black text-xs font-semibold leading-5">Dr. {selectedDoctor.name}</div>
							...
							<>
								<div className="text-black text-xs font-semibold leading-5">No Doctor Selected</div>{" "}
							</>
						)}
					</span>

					<div className="flex flex-col items-stretch w-[75%] ml-5 max-md:w-full max-md:ml-0">
						<div className="text-black text-base font-semibold leading-6">Selected Patient</div>
						{selectedPatient.name ? (
							<>
								<div className="flex items-stretch justify-between gap-4 mt-5">
									...
									<span className="self-center flex grow basis-[0%] flex-col">
										<div className="text-black text-xs font-semibold leading-5">{selectedPatient.name}</div>
							...
							<>
								<div className="text-black text-xs font-semibold leading-5">No Patient Selected</div>
							</>
						)}
					</div>
				</div>
			...
			<div className="flex flex-col w-[98.5%]  pl-10 mt-5">
				<div className="border border-[color:var(--background-background-600,#E8E8E8)] shadow-sm bg-white px-4 py-5 rounded">
					<div className="text-black text-base font-semibold">Notes/Remarks:</div>
					<div className="notes-remarks mt-3 rounded-lg">
						<textarea
							disabled={selectedDoctor.name || selectedPatient.name ? false : true}
							placeholder={
