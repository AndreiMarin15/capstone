...
export default function Referral() {
  ...
  const sendOTP = () => {
    ...
    myHeaders.append(
      "Authorization",
      "App 7d2e0e242c3f8670153f59be6678b030-7f61fffc-c227-4d3b-a67a-5921d22ce02b"
    );
      ...
      messages: [
        {
          ...
          text: `Hello! Your OTP is  ${otp}
					...
					*For privacy and security purposes, the Information above are mere sample data and does not represent your true results*
