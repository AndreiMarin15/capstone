	...
	const handleSpecializationFilter = (specialization) => {
		setSelectedSpecializations((prevSelected) => {
			if (prevSelected.includes(specialization)) {
				return prevSelected.filter((selectedSpecialization) => selectedSpecialization !== specialization);
			} else {
									...
									<div className="w-full flex justify-between ml-5 mb-5">
										...
										<DropdownMenu>
											...
											<DropdownMenuContent className="w-56">
												...
												<DropdownMenuCheckboxItem
													checked={selectedSpecializations.includes("endocrinologist")}
													onCheckedChange={() => handleSpecializationFilter("endocrinologist")}
												>
													Endocrinologist
												</DropdownMenuCheckboxItem>
												<DropdownMenuCheckboxItem
													checked={selectedSpecializations.includes("cardiologist")}
													onCheckedChange={() => handleSpecializationFilter("cardiologist")}
												>
													Cardiologist
												</DropdownMenuCheckboxItem>
												<DropdownMenuCheckboxItem
													checked={selectedSpecializations.includes("gastroenterologist")}
													onCheckedChange={() => handleSpecializationFilter("gastroenterologist")}
												>
													Gastroenterologist
												</DropdownMenuCheckboxItem>
											</DropdownMenuContent>
