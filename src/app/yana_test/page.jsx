        ...
        <div className="flex">
          ...
          <div className="flex flex-col w-1/2 max-w-[50%] md:order-last px-5">
            <div className="flex flex-col grow max-md:mt-10 max-md:max-w-full">
              ...
              <div
                className="flex z-10 flex-col py-11 mt-0 text-sm font-medium leading-5 shadow-sm bg-stone-50 max-md:max-w-full"
                style={{ width: "780px" }}
              >
              ...
              >
                ...
                <div className="flex w-full items-center justify-between gap-5 mt-2.5 pr-4 max-md:max-w-full max-md:flex-wrap">
                  <span className="flex items-stretch gap-2 my-auto">
                    ...
                    />
                    <button
                      className="text-zinc-500 text-sm font-medium leading-5 self-center grow whitespace-nowrap my-auto"
                      onClick={handlePullRecords}
                    >
                      Pull Records
                    </button>
                  </span>
                  <button className="text-sm font-semibold whitespace-nowrap justify-center items-stretch bg-sky-900 text-white self-stretch px-7 py-2 rounded max-md:px-5">
                    SEND
                  </button>
                </div>
              </div>
        ...
        <div className="fixed top-0 left-0 z-50 w-full h-full flex items-center justify-center bg-gray-900 bg-opacity-60">
          ...
          <div className="bg-white py-8 rounded shadow-lg flex flex-col items-center max-w-full w-[950px]">
            ...
            <div className="mt-5 leading-5 text-gray-500 text-center max-md:max-w-full">
              This means that our middleware will have to retrieve and store
              your personal health
              <br />
              data for referred doctors to be able to give you the best possible
              treatment possible.
            </div>
            ...
            <div className="flex gap-5 mt-8 max-md:flex-wrap w-[500px]">
              ...
              <div className="flex-auto">
                ...
                <span className="text-sm">
                  Such as but not limited to your full name, age, birthday,
                  gender, address, and your contact information.
                </span>
              </div>
            </div>
            <div className="flex gap-5 mt-6 max-md:flex-wrap w-[500px]">
              ...
              <div className="flex-auto">
                ...
                <br />
                <span className="text-sm">
                  Including clinic visits, biometrics, family, social, and
                  medical history, allergens, recorded vital signs, medications,
                  and care plans.
                </span>
              </div>
            </div>
            <div className="flex gap-4 mt-9 max-md:flex-wrap w-[500px]">
              ...
              <div className="flex-auto">
                ...
                <br />
                <span className="text-sm">
                  This includes laboratory tests that the referred doctor would
                  want to view from your end.
                </span>
              </div>
            </div>
        ...
        <div className="fixed top-0 left-0 z-50 w-full h-full flex items-center justify-center bg-gray-900 bg-opacity-60">
          <div className="bg-white py-8 rounded shadow-lg flex flex-col items-center max-w-full w-[950px]">
            ...
            <button className="flex gap-5 px-5 py-5 mt-9 max-w-full rounded-xl border border-solid border-zinc-600 w-[366px]">
              <div className="flex-auto text-black text-start">
                Privacy Policy
              </div>
