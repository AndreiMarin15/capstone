  ...
  useEffect(() => {
    const fetchPatientsDiagnoses = async () => {
      const diagnosesPromises = criticalPatients.map((criticalPatient) =>
        getPatientAndFinalDiagnosis(
          criticalPatient?.resource?.subject?.reference
        ...
        >
          ...
          >
            ...
            <div className="flex justify-between gap-5 px-5 w-full max-md:flex-wrap max-md:max-w-full">
              ...
              <div className="mt-8 text-sm text-blue-500 max-md:max-w-full">
                <button
                  onClick={() => {
                    downloadPDF();
                  }}
            ...
            <div className="flex flex-col grow shrink-0 self-start px-8 mt-8 basis-0 leading-[150%] w-fit max-md:mt-10 max-md:max-w-full overflow: scroll">
              <div className="ml-4 text-base font-semibold text-black max-md:max-w-full">
                Date Generated:{" "}
                ...
                Generated by:{" "}
                <span className="font-normal">
                  Dr. {currentUser.getState().user.first_name}{" "}
            ...
            <div className="flex flex-col">
              <div className="flex-1 mt-4 ml-8 mr-4 text-sm">
                {/* Table component */}
                <Table>
                  {/* To change to button */}
                  <TableHeader>
