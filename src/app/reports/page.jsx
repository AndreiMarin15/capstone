	...
	return (
		<div className="bg-white h-screen flex" style={{ overflowY: "scroll", maxHeight: "100vh" }}>
			<div className="flex flex-col grow shrink-0 self-start px-8 mt-14 basis-0 leading-[150%] w-fit max-md:mt-10 max-md:max-w-full h-[100vh]">
				...
				<div className="mt-8 text-base font-semibold text-black max-md:max-w-full">GENERATE:</div>
									...
									{genReport?.map((item, index) => (
										<tr key={index} className="h-8">
											<td className="border-l-[12px] border-transparent">
												<div className="text-black text-xs leading-5 self-center my-auto">{item.variable}</div>
											</td>
