		...
		<div className="bg-white h-screen flex" style={{ overflowY: "scroll", maxHeight: "100vh" }}>
			<div className="flex flex-col grow shrink-0 self-start px-8 mt-14 basis-0 leading-[150%] w-fit max-md:mt-10 max-md:max-w-full">
				...
				<div className="flex justify-between gap-5 px-5 w-full max-md:flex-wrap max-md:max-w-full">
					<div className="mt-8 text-base font-semibold text-black max-md:max-w-full">REFERRED PATIENTS LIST</div>
				...
				<div className="flex flex-col">
					<div className="mt-4 w-[30%]">
						{/* Dropdown component */}
						<label htmlFor="practitionerSelect" className="block text-sm font-medium text-gray-700">
							Practitioner
						</label>
						<select
							...
							<TableBody>
								{patientInfo?.map((item, index) => (
									<TableRow key={index}>
										...
										<TableCell className="text-left">{item.datereferred}</TableCell>
