    ...
    <>
      <span className="items-stretch flex-col self-start">
        ...
        <input
          ...
          className="mt-[10px] w-64 text-black text-sm whitespace-nowrap rounded shadow-sm flex-shrink-0 justify-center items-stretch px-2 py-2.5 border-[0.5px] border-solid border-black"
        />
      </span>
      <span className="items-stretch flex-col self-start">
        <div className="text-black text-sm font-semibold leading-5">
