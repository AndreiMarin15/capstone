...
import { getEncounters, getEncounterByPatientId } from "@/backend//health_records/getEncounter";
			...
			{currentScreen === 0 && (
				<div>
					<div className="flex justify-between">
						<div className="text-black text-base font-bold leading-5 mt-8 mb-1 max-md:ml-1 max-md:mt-10">LAB TESTS</div>
