						...
						<thead>
							<tr>
								...
								{vitals.map((item, index) => (
									<th key={index} className="border-transparent text-black text-xs leading-5 font-semibold py-2 px-4">
										{item.date}
									</th>
								))}
							</tr>
								...
								<tr key={index}>
									...
									{vitals.map((item, idx) => (
										<td key={idx} className="text-center">
											{item[property] && <div className="text-black text-small leading-5">{item[property]}</div>}
										</td>
									))}
