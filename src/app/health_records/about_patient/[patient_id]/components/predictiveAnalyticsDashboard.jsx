  ...
  return (
    <>
      ...
      <div className="text-justify w-[100%]">
        {" "}
        <div className="font-normal text-sm mt-5 mb-5">
          ...
          <div className="mb-5" style={{ color: "orange", fontWeight: "600" }}>
          ...
          <div className="mb-5" style={{ color: "red", fontWeight: "600" }}>
      ...
      <table className="max-w-fit border-spacing-y-5 border-spacing-x-[5em] border-separate text-sm">
      ...
      <div
        className="font-extrabold text-base mt-10 mt-5"
        style={{ color: "blue" }}
      >
        Result:{" "}
      ...
      <div
        className={`text-base font-bold mb-10 ${
          percentage < 10
            ? "text-green-600"
