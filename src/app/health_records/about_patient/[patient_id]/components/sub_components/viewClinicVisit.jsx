...
export default function ViewClinicVisit({
  currentPage,
  setCurrentPage,
  patientId,
  encounterId,
  ...
  React.useEffect(() => {
    async function fetchEncountersAndObservations() {
      try {
        ...
        if (
          Array.isArray(encounterContained) &&
          encounterContained.length > 0
        ) {
        ...
        const observationIds = observationsData?.map(
          (observation) => observation.id
        );

        // Filter observationIds by newContainedIDs
        const filteredObservationIds = observationIds.filter((id) =>
          newContainedIDs.includes(id)
        );
        ...
        if (finalDiagnosisObservation) {
          ...
          console.log(
            "Final Diagnosis:",
            finalDiagnosisObservation.valueString
          );
        }
        ...
        if (signsAndSymptomsObservation) {
          ...
          console.log(
            "Signs and Symptoms:",
            signsAndSymptomsObservation.valueString
          );
        }
        ...
        if (reviewOfSystemsObservation) {
          ...
          console.log(
            "Review of Systems:",
            reviewOfSystemsObservation.valueString
          );
        }
        ...
        if (otherReviewOfSystemsObservation) {
          ...
          console.log(
            ...
            otherReviewOfSystemsObservation.valueString
          );
        }
        ...
        if (suggestedNextVisitObservation) {
          ...
          console.log(
            ...
            suggestedNextVisitObservation.valueString
          );
        }
        ...
        <>
          ...
          <div>
            <div className="flex gap-[4rem] align-baseline">
                    ...
                    <tr key={index} className="h-8">
                      <td className="w-5 border-l-[16px] border-transparent">
                        <div className="flex items-center">
                          ...
                          />
                          <div className="text-black text-sm font-semibold leading-5 self-center my-auto ml-2">
                            {item.variable}
                          </div>
                        </div>
                      </td>
                      ...
                      <td className="w-5 border-l-[16px] border-transparent">
                        <div className="flex items-center">
                          <Image
                            ...
                            className="self-start aspect-square fill-black w-[15px]"
                          />
                          <div className="text-black text-sm font-semibold leading-5 self-center my-auto ml-2 whitespace-nowrap">
                            {item.variable}
                          </div>
                        </div>
                      </td>
              ...
              <table className="max-w-fit border-spacing-y-7 border-separate">
                <tbody className="leading-5 text-black">
                  <div className="text-baseleading-5 text-black font-bold">
                    {" "}
                    VITALS
