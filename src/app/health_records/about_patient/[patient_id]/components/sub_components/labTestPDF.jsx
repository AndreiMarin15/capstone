...
export default function LabTestPDF() {
	return (
		<div className="flex flex-col px-14 py-20 bg-white rounded border border-gray-200 border-solid shadow-sm max-w-[867px] max-md:px-5">
				...
				<div className="flex gap-5 max-md:flex-col max-md:gap-0">
					...
					<div className="flex flex-col ml-5 w-[63%] max-md:ml-0 max-md:w-full">
						<div className="self-stretch my-auto text-xs font-semibold leading-5 text-black max-md:mt-10">
							Address
							<br />
							<span className="font-normal">#9 Leveriza Street, Pasay City, Metro Manila</span>
						</div>
					</div>
				</div>
			</div>
			<div className="mt-16 text-xs leading-5 text-black max-md:mt-10 max-md:max-w-full">
				...
				<ul className="list-disc mt-0">
					<li className="ml-2">HbA1c(Glycated Hemoglobin)</li> <li className="ml-2">Fasting Blood Sugar Test</li>{" "}
