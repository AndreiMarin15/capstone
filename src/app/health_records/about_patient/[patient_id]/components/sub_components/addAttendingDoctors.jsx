...
export default function AddAttendingDoctors({ currentScreen, setCurrentScreen, patientId }) {
    ...
    console.log(attendingDoctorData);
		await addAttendingDoctor(attendingDoctorData.doctor, attendingDoctorData.patient);
		setCurrentScreen(2);
	};
	const handleChange = (index, newValue) => {
		setAttendingDoctors((currentDoctors) =>
			currentDoctors.map((doctor, i) => (i === index ? { ...doctor, value: newValue } : doctor))
		);
	};
