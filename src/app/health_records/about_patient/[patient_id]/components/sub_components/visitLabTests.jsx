...
import { getObservationsWithLabTest } from "../../../../../../../lib/backend/health_records/getObservation";
...
export default function VisitLabtests({ currentScreen, setCurrentScreen, observationId }) {
  ...
  const medication = selectedObservation
    ? [
        {
          srcmedicine: "https://cdn.builder.io/api/v1/image/assets/TEMP/4a525f62acf85c2276bfc82251c6beb10b3d621caba2c7e3f2a4701177ce98c2?",
