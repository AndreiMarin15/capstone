...
export default function ViewLabRequest({ currentScreen, setCurrentScreen, labTests, fetchEncounters, hideBackButton }) {
		...
		<>
			{currentScreen === 1 && (
				<>
					...
					{!hideBackButton && <BackButton currentScreen={currentScreen} setCurrentScreen={setCurrentScreen} />}
