								...
								<tr>
									...
									<td className="border-l-[5px] border-transparent">
										<div className="text-black text-xs font-regular leading-5 ml-0.5">
											From {item.resource.dispenseRequest?.validityPeriod?.start} to{" "}
											{item.resource.dispenseRequest?.validityPeriod?.end}
										</div>
									</td>
									<td className="border-l-[5px] border-transparent">
										<div className="text-black text-xs font-regular leading-5 ml-0.5">
											<Button className="mr-1" variant="outline" onClick={() => handleEditMedication(item.id)}>
												Edit
											</Button>
											<Button variant="destructive" onClick={() => handleRemoveMedication(item.id)}>
												Delete
											</Button>
										</div>
									</td>
								...
								<tr>
									...
									<td className="flex  border-l-[5px] border-transparent">
										...
										<div
											...
											style={{ whiteSpace: "normal", maxWidth: "200px" }}
										>
											<span className="font-semibold">Form:</span> {item.resource.form?.text}
										</div>
										<div
											className="text-black text-xs font-regular leading-5 ml-10"
											style={{ whiteSpace: "normal", maxWidth: "200px" }}
										...
										<div
											...
											style={{ whiteSpace: "normal", maxWidth: "200px" }}
										>
											<span className="font-semibold">Instructions:</span> {item.resource.note}
										</div>
									</td>
								</tr>
							</React.Fragment>
