...
export default function AttendingDoctors({currentScreen, setCurrentScreen}) {
    ...
    const sampleAttendingDoctors = [
        { name: "Dr. Maria Santos", specialty: "Cardiologist", hospital: "RM 123 Philippine General Hospital", status: "Accepted" },
        { name: "Dr. Angelo Cruz", specialty: "Gastroenterologist", hospital: "RM O124 Taytay Hospital", status: "Accepted" },
    ];
                ...
                <div className="flex flex-col">
                    ...
                    {attendingDoctors
                        ...
                        .map((doctor, index) => (
                            <div
                                key={index}
                                className="mt-5 items-start text-xs leading-5 text-black max-w-[1000px]"
                            >
                               <div className="items-start text-xs  text-black max-w-[1000px]">
                                    ...
                                    <div className="flex justify-between mt-2 ml-12 gap-5">
                                        ...
                                        <div className="flex flex-grow justify-end">
                                            {doctor.status === "Accepted" && (
                                                <button className="border border-red-500 font-bold rounded px-3 py-1 text-red-600">
                                                    Remove
                                                </button>
                                            )}
                                        </div>
