														...
														<textarea
															...
															style={{
																height: ["Review of Systems", "Signs and Symptoms"].includes(item.variable)
																	...
																	: "auto",
																whiteSpace: "pre-wrap",
																...(item.variable === "Review of Systems" && errorStyles.reviewOfSystems
																	? {
																			...errorStyles.reviewOfSystems,
																			borderColor: "red",
																			borderWidth: "2px",
																		}
																	: item.variable === "Signs and Symptoms" && errorStyles.signsAndSymptoms
																		? {
											...
											<tr key={index} className="h-8">
												...
												<td className="border-l-[5rem] border-transparent text-xs font-normal">
													<input
														...
														style={
															item.variable === "Systolic Blood Pressure" && errorStyles.systolic
																? {
																		...errorStyles.systolic,
																		borderColor: "red",
																		borderWidth: "2px",
																	}
																: item.variable === "Diastolic Blood Pressure" && errorStyles.diastolic
																	? {
																			...errorStyles.diastolic,
																			borderColor: "red",
																			borderWidth: "2px",
																		}
																	: item.variable === "Heart Rate (beats/min)" && errorStyles.heartRate
																		? {
											...
											<tr key={index} className="h-8">
												...
												<td className="border-l-[5rem] border-transparent text-xs font-normal">
													<input
														...
														value={
															item.variable === "Height (cm)" ? height : item.variable === "Weight (kg)" ? weight : bmi
														}
														onChange={(e) => {
															// Update the corresponding state variable based on the input field
														...
														style={
															item.variable === "Height (cm)" && errorStyles.height
																? {
																		...errorStyles.height,
																		borderColor: "red",
																		borderWidth: "2px",
																	}
																: item.variable === "Weight (kg)" && errorStyles.weight
																	? {
																			...errorStyles.weight,
																			borderColor: "red",
																			borderWidth: "2px",
																		}
																	: item.variable === "Body Mass Index" && errorStyles.bmi
																		? {
																				...errorStyles.bmi,
																				borderColor: "red",
																				borderWidth: "2px",
