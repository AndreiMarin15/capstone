		...
		if (vitalsAndBio) {
			...
			Object.keys(vitalsAndBio).forEach((key, index) => {
				...
				vitals.push({
					number: index + 1,
					date: key,
					systolic: item.systolic?.valueQuantity?.value + " " + item.systolic?.valueQuantity?.unit,
					diastolic: item.diastolic?.valueQuantity?.value + " " + item.diastolic?.valueQuantity?.unit,
					heartrate: item.heartRate?.valueQuantity?.value + " " + item.heartRate?.valueQuantity?.unit,
					height: item.height?.valueQuantity?.value + " " + item.height?.valueQuantity?.unit,
					weight: item.weight?.valueQuantity?.value + " " + item.weight?.valueQuantity?.unit,
				});
			});
