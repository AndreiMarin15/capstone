								...
								>
									...
									>
										...
										<div className="flex gap-5 justify-between ml-7 max-md:ml-2.5 max-w-[1000px]">
											...
											{medication.resource.requester.agent.reference === currentUser?.fullName &&
										...
										<div className="flex justify-between mt-2">
											...
											<div className="flex-grow ml-7 my-auto">
												Dosage: {medication.resource.dosageInstruction[0]?.doseAndRate[0]?.doseQuantity?.doseUnit || ""}
											</div>
											<div className="flex-grow ml-7 my-auto">
												Frequency:{" "}
											...
											<div className="flex-grow ml-7 my-auto">
												Possible Side Effect: {medication.resource.adverseEvent.adverseReaction}
											</div>
										</div>
									</div>
