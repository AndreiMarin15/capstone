...
export default function MasterData() {
  ...
  return (
	...
	{currentPage === 0 ? (
	<>
    	<div className="text-black text-base font-bold leading-5 mt-8 mb-1 max-md:ml-1 max-md:mt-10 flex justify-between items-center">CLINIC VISIT	
			<button 
		...
		<button key={index} className="flex gap-2.5 mt-10 mb-4 text-xs text-black" onClick={handleVisitClick}>
			<Image
			alt="image"
			height={0}
			width={0}
