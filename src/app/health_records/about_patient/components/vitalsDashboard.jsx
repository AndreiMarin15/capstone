        ...
        <div className="flex items-center">
            ...
            <span className="flex items-center gap-1 px-1 py-1 mt-10 rounded-md border-[0.5px] border-solid border-black font-normal">
                ...
                <div className="text-black text-xs leading-5 self-center">SORT</div>
                    ...
                    <a href="/path/to/pdf" download="full_vitals_history.pdf" className="text-blue-500 text-xs block flex items-center">
                        ...
                        <thead>
                            <tr>
                                ...
                                {vitals.map((item, index) => (
                                    <th key={index} className="border-transparent text-black text-xs leading-5 font-semibold py-2 px-4">{item.date}</th>
                                ))}
                            </tr>
                        </thead>
                        <tbody>
