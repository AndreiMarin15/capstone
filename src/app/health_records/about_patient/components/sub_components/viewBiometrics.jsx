...
export default function ViewBiometrics({ currentPage, setCurrentPage, defaultMetric }) {
        ...
        datasets: [
          {
            ...
            data: sampleData[selectedMetric].map(({ date, value }) => ({ x: new Date(date), y: value })),
            borderColor: '#0000FF',
            borderWidth: 3,
            pointRadius: 6,
            fill: false,
  ...
  const sampleData = {
    height: [
      { date: '2024-03-01', value: 162 },
      { date: '2024-03-03', value: 162 },
      { date: '2024-03-05', value: 164 },
      { date: '2024-03-07', value: 167 },
      { date: '2024-03-09', value: 169 },
      { date: '2024-03-11', value: 171 },
      { date: '2024-03-13', value: 171 },
      { date: '2024-03-15', value: 171 }
    ],
    weight: [
      { date: '2024-03-01', value: 65 },
      { date: '2024-03-03', value: 66 },
      { date: '2024-03-05', value: 67 },
      { date: '2024-03-07', value: 66 },
      { date: '2024-03-09', value: 65 },
      { date: '2024-03-11', value: 64 },
      { date: '2024-03-13', value: 63 },
      { date: '2024-03-15', value: 62 }
    ],
    bmi: [
      { date: '2024-03-01', value: 23 },
      { date: '2024-03-03', value: 23.5 },
      { date: '2024-03-05', value: 24 },
      { date: '2024-03-07', value: 24.2 },
      { date: '2024-03-09', value: 24.1 },
      { date: '2024-03-11', value: 24 },
      { date: '2024-03-13', value: 23.9 },
      { date: '2024-03-15', value: 23.8 }
    ]
  };
        ...
        <div className="flex justify-between">
          ...
          <div className="flex items-center">
            <div className="text-black text-xl font-bold leading-5 mt-8 mb-1 mr-96 max-md:ml-1 max-md:mt-10">
              {selectedMetric === 'bmi' ? 'BMI' : (selectedMetric ? selectedMetric.charAt(0).toUpperCase() + selectedMetric.slice(1) : '')}
            </div>
          </div>
        </div>
          ...
          <table className="min-w-full">
            <thead>
              <tr>
                ...
                <th className="px-4 py-2">{selectedMetric === 'bmi' ? 'BMI' : (selectedMetric ? selectedMetric.charAt(0).toUpperCase() + selectedMetric.slice(1) : '')}</th>
              </tr>
            </thead>
            <tbody>
