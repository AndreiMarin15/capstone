  ...
  return (
    <div className="container mx-auto mt-16 flex h-auto pb-10">
      ...
      <div className="w-1/2 pl-8">
        <div className="text-black text-base font-semibold leading-5 flex items-stretch justify-between gap-5 mr-9 mt-6 max-md:max-w-full max-md:flex-wrap max-md:mr-2.5 max-md:mt-10">
        ...
        <div className="text-black text-basefont-semibold leading-5 flex items-stretch justify-between gap-5 mr-4 mt-4 max-md:max-w-full max-md:flex-wrap max-md:mr-2.5 max-md:mt-10">
        ...
        <div className="text-black text-basefont-semibold leading-5 flex items-stretch justify-between gap-5 mr-9 mt-6 max-md:max-w-full max-md:flex-wrap max-md:mr-2.5 max-md:mt-10">
              ...
              <div className="flex">
                <div className="inline-block relative">
                  <input
                    ...
                    type="text"
                    value={inputValue}
                    className="text-black rounded text-sm shadow-sm h-[30px]  flex-grow flex-col mt-2 border-[0.5px] px-auto py-4 border-solid border-black text-left"
            ...
            <span className="flex grow basis-[0%] flex-col items-stretch">
              ...
              <div className="flex justify-between gap-2.5 mt-2">
                <input
                  ...
                  type="number"
                  className="text-black text-base leading-5 whitespace-nowrap rounded shadow-sm flex-shrink-0  justify-center items-stretch px-2 py-2.5 border-[0.5px] border-solid border-black"
                  placeholder="YYYY"
                />
              </div>
            </span>
