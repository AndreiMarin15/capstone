...
React.useEffect(() => {
  ...
  async function fetchEncountersAndObservations() {
    ...
    try {
      ...
      const reviewOfSystemsObservation = filteredObservationData.find(observation => observation.id === "reviewOfSystems");
      ...
      const otherConcernsObservation = filteredObservationData.find(observation => observation.id === "otherConcerns");
      ...
      const suggestedNextVisitObservation = filteredObservationData.find(observation => observation.id === "suggestedNextVisit");
