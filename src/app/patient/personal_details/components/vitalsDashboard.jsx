...
import { getVitalsAndBiometrics, getBiometrics } from "@/backend//patient/vitalsAndBiometrics/vitalsAndBiometrics";
export default function Vitals() {
	...
	return (
		<>
					...
					<div className="flex justify-between">
						<div className="text-black text-base font-bold leading-5 mt-8 mb-2 max-md:ml-1 max-md:mt-10">
							...
							<div className="flex items-center justify-between">
								<span className="text-black text-base leading-5">Rendering Options:</span>
								...
								<span className="ml-2 text-black text-base text-xs leading-5 font-normal">Appointments</span>
							</div>
						</div>
			...
			{currentPage === 1 && <AddVitals currentPage={currentPage} setCurrentPage={setCurrentPage} />}
			{currentPage === 2 && <ViewSystolic currentPage={currentPage} setCurrentPage={setCurrentPage} />}

			{currentPage === 3 && <ViewHeartRate currentPage={currentPage} setCurrentPage={setCurrentPage} />}
