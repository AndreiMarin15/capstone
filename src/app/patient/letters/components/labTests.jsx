	...
	return (
		<>
			{currentScreen === 0 ? (
				<TabsContent value="labtestrequest">
					...
					<div className="flex justify-between mt-2">
						<div className="flex items-center">
							<span className="ml-5 text-black text-sm font-bold leading-5">Rendering Options:</span>
							<select
							...
							<span className="ml-2 text-black  leading-5 text-sm font-normal">Lab test requests</span>
						</div>
						<DropdownMenu>
									...
									<Reusable
										child={
											<ViewLab
												...
												labTests={labTests[encounterId]} // Pass lab test data for the selected encounter
				...
				<VisitLab currentScreen={currentScreen} setCurrentScreen={setCurrentScreen} observationId={observationId} />
			) : (
				""
			)}
		</>
