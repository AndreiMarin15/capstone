								...
								>
									<div className="ml-5 flex gap-2 items-center">
										...
										<div className="text-xs font-semibold">
											...
											{labtest?.resource?.codeText ?? "Lab Test"}
										</div>
									</div>
									<div className="flex gap-5 justify-between ml-7  max-md:ml-2.5 w-[100%]">
										<div className="flex gap-1 justify-between font-medium whitespace-nowrap">
											...
											<div className="grow my-auto">
												{labtest?.resource?.participant?.actor.length > 0
													? labtest?.resource?.participant?.actor
													: "No Doctor"}
											</div>
										</div>
										<div
										...
										>
											<div>
												...
												{labtest?.resource?.requestedDateTime ?? ""}
											</div>
										</div>
										...
										<div className="text-black text-xs font-medium leading-5 flex items-center">
											...
											{labtest?.resource?.status ?? "Lab Test"}
										</div>
										...
										<Reusable
											child={
												<LabTest
													...
													referred_by_id={labtest?.resource?.participant?.actor}
												/>
											}
											filename={`labtest_${labtest?.resource?.codeText}`}
										/>
									</div>
								</button>
							</>
