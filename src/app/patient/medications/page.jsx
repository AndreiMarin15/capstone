...
export default function MedicationsDashboard() {
  ...
  return (
    <div className="h-screen"> {/* Set the height to full screen */}
      {isTest ? (
        <ViewMedications
          currentScreen={3}
        ...
        <div className="border h-full w-full bg-white flex flex-col px-20 py-12 border-solid border-stone-300 max-md:px-5">
