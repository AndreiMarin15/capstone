        ...
        >
          <div className="flex flex-col gap-5 mt-11 max-md:max-w-full max-md:flex-wrap max-md:mt-10">
            ...
            <div className="flex items-stretch mt-8">
              {/* Status section */}
              <div className="font-semibold text-black flex gap-1 items-center text-base self-start mt-3">
                Status:
                <button
                ...
                >
                  <div className="justify-start items-start py-2 pr-4 pl-3 text-sm rounded border border-black border-solid shadow-sm max-md:pr-5">
                    {status}
                  </div>
                </button>
              </div>
            ...
            {medications
              ...
              ?.map((medication, index) => (
                ...
                >
                  <div
                    key={index}
                    className="flex flex-col mt-10 items-start text-sm leading-5 text-black max-w-[1000px] mr-10"
                  >
