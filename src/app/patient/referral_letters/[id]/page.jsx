...
export default function ReferralLetter({ params }) {
  ...
  return (
    <div className="flex flex-col h-screen mx-4 self-stretch my-auto max-md:mt-10 max-md:max-w-full">
      ...
      <div className="flex gap-5 px-5 mt-11 w-full text-sm font-medium leading-5 max-md:flex-wrap max-md:mt-10 max-md:max-w-full">
        <div className="flex gap-2.5 text-black">
          ...
          <div className="flex-auto">
            Referral Letter to Dr. {referralDetails.doctor_name}
          </div>
        </div>
        <div
          onClick={() => {
      ...
      <div
        ref={pdfRef}
        className="flex flex-col px-9 pt-5 pb-20 mt-8 text-sm leading-5 text-black bg-white rounded border border-gray-200 border-solid shadow-sm max-md:px-5 max-md:max-w-full"
      >
        <div className="font-semibold max-md:max-w-full">
          To: Dr. {referralDetails.doctor_name}
        </div>
        <div className="mt-3.5 font-semibold max-md:max-w-full">
          {referralDetails.specialization}
        </div>
