...
import referralLetters from "../../../../lib/backend/referral_letters/getData";
					...
					<div className="flex flex-col mt-20 max-md:mt-10 max-md:max-w-full">
						<div className="flex gap-5 w-full max-md:flex-wrap max-md:pr-5 max-md:max-w-full">
							...
							<div className="flex gap-2.5">
								<div className="flex flex-col justify-center text-xs leading-5 whitespace-nowrap text-stone-300">
								...
								<div className="flex flex-col justify-center text-xs leading-5 text-black whitespace-nowrap">
