...
import { getObservationById, updateObservation } from "@/backend/health_records/getObservation";
...
export default function UploadLab({ currentPage, setCurrentPage, observationId, setCurrentScreen }) {
	...
	return (
		<span
			className="bg-white flex flex-col px-20 py-12 h-auto max-md:px-5"
		...
		>
			...
			<div className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
				<div className="self-start w-full max-w-[925px] mt-12 mb-56 max-md:max-w-full max-md:my-10">
							...
							<tr>
								<td colSpan="4" className="text-center">
									...
									>
										...
										<div className=" my-auto text-xs text-gray-400">Add another row</div>
									</button>
								</td>
							</tr>
						</tbody>
					...
					{isModalOpen && <ImageModal src={uploadedImageSrc} onClose={handleCloseModal} />}
				</div>
			</div>
		</span>
	);
