...
export default function ViewBiometrics({
  currentPage,
  setCurrentPage,
  defaultMetric,
  chartValues,
  ...
  useEffect(() => {
    ...
    if (selectedMetric && chartValues[selectedMetric]) {
      setData({
        labels: chartValues[selectedMetric]
        ...
        datasets: [
          {
            ...
            data: chartValues[selectedMetric]
              .slice(-renderingOptions)
              .map(({ date, value }) => ({
                x: new Date(date),
                y: value,
          ...
          <div className="flex mb-5">
            <div className="custom-select">
              <div className="options-container">
                <div
                  className={`option ${
                    selectedMetric === "height" ? "selected" : ""
                  }`}
                  style={
                    selectedMetric === "height"
                      ? { border: "2px solid #006B55" }
                      : null
                  }
                ...
                <div
                  className={`option ${
                    selectedMetric === "weight" ? "selected" : ""
                  }`}
                  style={
                    selectedMetric === "weight"
                      ? { border: "2px solid #006B55" }
