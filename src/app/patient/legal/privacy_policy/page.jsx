    ...
    <div className="flex flex-col bg-white text-justify">
      ...
      <div className="flex flex-col px-14 mt-9 w-full max-md:px-5 max-md:max-w-full">
        ...
        <div className="mt-6 text-sm leading-5 text-black  max-md:max-w-full">
          ...
          information. This section explains how we use your data within the
          Electronic Health Record (EHR) system and the role of our middleware.
          <br />
          <br />
          We use your data to:
          <ul className="list-disc ml-5 mt-4">
            ...
            <li>
              Coordinate your care: We may share your information with other
              healthcare providers involved in your care, with your
              authorization.
            </li>
            <li>
        ...
        <div className="mt-6 text-sm leading-5 text-black  max-md:max-w-full">
          ...
          <br />
          Your information may be used to generate data substantial to the
          enhancement of the electronic health records services. We will be
          obtaining informed consent from you or your authorized representative
          before the use of your personal data.
        </div>
        ...
        <div className="mt-6 text-sm leading-5 text-black  max-md:max-w-full">
          We retain your health information for as long as required by law or as
          necessary to accomplish a legitimate purpose. Here's a breakdown of
          ...
          <ul className="list-disc ml-5 mt-4">
            <li>
              ...
              from our affiliated providers, we will retain your information to
