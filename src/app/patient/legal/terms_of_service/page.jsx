  ...
  <div className="ml-8 mb-8 mr-8">
    <p className="text-gray-700">
     ...
     Welcome to EndoTracker! These Terms of Service ("Terms") govern your access to and use of the EndoTracker website and any related services provided by us. By accessing or using our website, you agree to be bound by these Terms.
        ...
        <ul className="text-gray-700 ml-8">
            <li>To the fullest extent permitted by law, EndoTracker and its affiliates shall not be liable for any indirect, incidental, special, consequential, 
                ...
                intangible losses, resulting from (a) your access to or use of or inability to access or use our services; (b) any conduct or content of any 
                third party on our services; or (c) unauthorized access, use, or alteration of your transmissions or content.</li>
        ...
        <ul className="text-gray-700 ml-8">
            <li>You agree to indemnify and hold EndoTracker and its affiliates harmless from any claims, losses, damages, liabilities, including legal fees, 
                arising out of your use or misuse of our services, your violation of these Terms, or your violation of any rights of a third party.</li>
        </ul><br />
        ...
        <ul className="text-gray-700 ml-8">
            <li>We reserve the right to modify these Terms at any time. If we make changes to these Terms, we will post the revised Terms on our website and 
                update the "Effective date" date at the top of these Terms. Your continued use of our services following the posting of the revised Terms 
