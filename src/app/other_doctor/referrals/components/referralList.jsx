									...
									<div className="flex gap-3 mt-6 whitespace-nowrap">
										<button
											onClick={async () => {
												...
												setAccepted(true);
												const approval = await retrieveReferralData.updateReferralRequest(referral.id, true);
										...
										<button
											onClick={async () => {
												const approval = await retrieveReferralData.updateReferralRequest(referral.id, false);
